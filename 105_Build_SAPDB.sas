...
proc contents data=casuser.mnt00; run;

data mnt01;
   merge sato.MBADS4320 (in=a keep=tdp_asset_name timestamp targetx)
         sato.mnt00 (in=b);
   by tdp_asset_name timestamp;
   if a and b;
   if mnt_category ne '';
...
proc freq data=sato.mbads4320; table mnt_category mnt_brg:; run;
proc freq data=mnt01; table mnt_category mnt_brg:; run;
...
data sato.MntSummaryMB; set work.MntSummaryFile00; run;
